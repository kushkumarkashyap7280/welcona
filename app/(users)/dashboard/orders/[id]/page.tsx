      ...
      {STATUS_STEPS.map((step, i) => {
        ...
        return (
          <div key={step} className="flex items-center">
            ...
            {!isLast && (
              <div
                className={`h-0.5 w-10 sm:w-16 md:w-24 mb-4 mx-1 transition-colors ${
            ...
            {order.orderItems.map((item) => {
              ...
              return (
                <div key={item.id} className="flex items-center gap-4">
                  <div className="h-16 w-16 shrink-0 overflow-hidden rounded-xl border border-border/70 bg-muted">
                    {img ? (
                      <ProductImage
                        src={img.image}
